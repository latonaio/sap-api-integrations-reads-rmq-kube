...
import (
	sap_api_caller "sap-api-integrations-xxxxxxxx-reads-rmq-kube/SAP_API_Caller"
	sap_api_input_reader "sap-api-integrations-xxxxxxxx-reads-rmq-kube/SAP_API_Input_Reader"
	"sap-api-integrations-xxxxxxxx-reads-rmq-kube/config"
...
func callProcess(caller *sap_api_caller.SAPAPICaller, msg rabbitmq.RabbitmqMessage) (err error) {
	...
	xxxxxxxx, xxxxxxxx := extractData(msg.Data())
	accepter := getAccepter(msg.Data())
	caller.AsyncGetXXXXXXXX(xxxxxxxx, xxxxxxxx, accepter)
	return nil
}

func extractData(data map[string]interface{}) (xxxxxxxx, xxxxxxxx string) {
